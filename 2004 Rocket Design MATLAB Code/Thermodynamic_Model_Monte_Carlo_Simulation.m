...
v_wind = normrnd(0.5,1.5)*0.45;
theta = normrnd(45,1); % initial angle of rocket
phi = normrnd(0,45);
T_air = normrnd(275.15,5);
m_water0 = normrnd(0.997,0.0005);
V_water0 = m_water0./c.rho_water;
V_air0 = c.Vbottle - V_water0;
P_atm = normrnd(83500,1000);
CD = normrnd(0.2,0.05);
P0 = P_atm + c.P_gage;
...
para = [v_wind, theta, phi, T_air, m_water0, P_atm, CD];

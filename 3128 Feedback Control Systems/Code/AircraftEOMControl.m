function xdot = AircraftEOMControl(t,aircraft_state,aircraft_surfaces0,wind_inertial,aircraft_parameters,kth,kq,ka,kp,kr)
...
aileron_perturb = RollControl(ka,kp,phi_c,euler_angles(1),omega_body(1));
yaw_perturb = kr*omega_body(3);
aircraft_surfaces = aircraft_surfaces0 + [elev_perturb; aileron_perturb; yaw_perturb; 0];
